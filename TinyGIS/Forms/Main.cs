...
using TinyGIS.Classes;
using TinyGIS.Forms;
using CCWin;

namespace TinyGIS
{
    public partial class TinyGIS : Skin_DevExpress
    {
        ...
        #region 14.路径查询
        private void DEMToolStripMenuItem_Click(object sender, EventArgs e)
        {
            DEMForm frmDEM = new DEMForm();
            frmDEM.Show(); 
        }
        #endregion
